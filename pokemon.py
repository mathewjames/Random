"""Python script to get details of all Pokemon from the official website."""
...
while True:
    ...
    if len(gender_details) == 2:
        ...
        class_name = gender_details[0].get("class")[1]
        gender_lst = re.findall(r"_(\S+)_", class_name)
        gender = gender_lst[0].title()
    else:
        gender = "Unknown"
